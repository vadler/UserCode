...
process.TriggerBitsRcdCreateNew = cms.EDAnalyzer( "AlCaRecoTriggerBitsRcdUpdate"
                                                , firstRunIOV = cms.uint32( 1 )
                                                , lastRunIOV  = cms.int32( -1 )
                                                , startEmpty = cms.bool( True )
                                                , listNamesRemove = cms.vstring()
                                                , triggerListsAdd = cms.VPSet( cms.PSet( listName = cms.string( 'selectGt' )
                                                                                       , hltPaths = cms.vstring( 'PhysicsDeclared'
                                                                                                               )
                                                                                       )
                                                                             , cms.PSet( listName = cms.string( 'selectL1' )
...
process.p = cms.Path( process.TriggerBitsRcdCreateNew
                    )
