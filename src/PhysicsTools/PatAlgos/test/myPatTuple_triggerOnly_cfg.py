...
, fileNames = cms.untracked.vstring(
    'file:/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_7_0_pre5/output/myHlt_triggerOnly.root'
  )
)
...
process.out = cms.OutputModule(
  "PoolOutputModule"
, fileName       = cms.untracked.string( '/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_7_0_pre5/output/myPatTuple_triggerOnly.root' )
