...
, fileNames = cms.untracked.vstring(
    'file:/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_8_0_pre5/output/myPatTuple_test_addTriggerInfo.root'
  )
)
...
, fileName = cms.string( '/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_8_0_pre5/output/myTest_test.root' )
)
