...
, fileNames = cms.untracked.vstring(
    'file:/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_7_0_patch1/output/myPatTuple_test_addTriggerInfo.root'
  )
)
...
, fileName = cms.string( '/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_7_0_patch1/output/myTest_test.root' )
)
