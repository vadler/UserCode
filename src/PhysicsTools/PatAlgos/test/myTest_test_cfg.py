...
, fileNames = cms.untracked.vstring(
    'file:/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_9_0_pre3/output/myPatTuple_test_addTriggerInfo.root'
  )
)
...
, fileName = cms.string( '/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_9_0_pre3/output/myTest_test.root' )
)
