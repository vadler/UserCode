...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_6_X_2010-02-22-0200/output/myPatLayer1_fromAOD_full.root'
    )
)
...
process.TFileService = cms.Service( "TFileService",
    fileName = cms.string( '/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_6_X_2010-02-22-0200/output/myTriggerTest.root' )
)
