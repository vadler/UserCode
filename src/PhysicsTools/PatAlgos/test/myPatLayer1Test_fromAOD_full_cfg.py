...
process.out.fileName        = '/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_6_X_2010-02-17-1100/output/myPatLayer1Test_fromAOD_full.root'
...
process.patTrigger = cms.EDProducer( "PATTriggerProducer",
    ...
    addPathModuleLabels = cms.bool( True )
)
