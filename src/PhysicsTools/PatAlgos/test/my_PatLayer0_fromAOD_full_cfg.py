...
process.patEventContent.outputCommands.extend(process.patLayer0EventContent.outputCommands)
...
process.out = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('output/PATLayer0_Output.fromAOD_full.root')
)
