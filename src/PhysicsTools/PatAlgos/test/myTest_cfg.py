...
, fileNames = cms.untracked.vstring(
    'file:/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_8_3/output/myPatTuple_addTriggerInfo.root'
  )
)
...
, fileName = cms.string( '/afs/cern.ch/user/v/vadler/cms/PAT/CMSSW_3_8_3/output/myTest.root' )
)
