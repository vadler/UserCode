...
PatTriggerAnalyzerWB::PatTriggerAnalyzerWB( const edm::ParameterSet & iConfig ) :
...
PatTriggerAnalyzerWB::~PatTriggerAnalyzerWB()
{
}


void PatTriggerAnalyzerWB::beginJob()
{
...
void PatTriggerAnalyzerWB::analyze( const edm::Event & iEvent, const edm::EventSetup & iSetup )
{
...
DEFINE_FWK_MODULE( PatTriggerAnalyzerWB );
