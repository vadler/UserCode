...
, logconnect = cms.untracked.string( 'sqlite_file:/afs/cern.ch/user/v/vadler/scratch0/cms/SiStripDQM/CMSSW_3_6_X_2010-05-05-1100/output/AlCaRecoTriggerBits_SiStripDQM_create_log.db' )
, timetype = cms.untracked.string( 'runnumber' )
, connect  = cms.string( 'sqlite_file:/afs/cern.ch/user/v/vadler/cms/SiStripDQM/CMSSW_3_6_X_2010-05-05-1100/output/AlCaRecoTriggerBits_SiStripDQM.db' )
, toPut    = cms.VPSet(
    cms.PSet(
