...
process.TrackerDQMTriggerBitsRcdUpdate = cms.EDAnalyzer( "AlCaRecoTriggerBitsRcdUpdate"
                                                       , firstRunIOV = cms.uint32( 124000 )
                                                       , lastRunIOV  = cms.int32( -1 )
                                                       , startEmpty = cms.bool( False )
                                                       , listNamesRemove = cms.vstring( 'TrackerDQM_L1_Tracking'
                                                                                      )
                                                       , triggerListsAdd = cms.VPSet( cms.PSet( listName = cms.string( 'TrackerDQM_L1_Tracking' )
...
process.p = cms.Path( process.TrackerDQMTriggerBitsRcdUpdate
                    )
