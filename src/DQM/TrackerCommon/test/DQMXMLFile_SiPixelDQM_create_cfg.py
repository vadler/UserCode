...
, Source          = cms.PSet(
    XMLFile    = cms.untracked.string( '/afs/cern.ch/cms/sw/slc5_ia32_gcc434/cms/cmssw/CMSSW_3_8_0_pre8/src/DQM/SiPixelMonitorClient/test/sipixel_tier0_qualitytest.xml' )
