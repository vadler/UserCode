...
, Source          = cms.PSet(
    XMLFile    = cms.untracked.string( '/afs/cern.ch/cms/sw/slc5_ia32_gcc434/cms/cmssw/CMSSW_3_6_1/src/DQM/SiPixelMonitorClient/test/sipixel_tier0_qualitytest.xml' )
...
process.CondDBCommon.connect          = cms.string( 'sqlite_file:/afs/cern.ch/user/v/vadler/scratch0/cms/SiStripDQM/CMSSW_3_6_1/output/DQMXMLFile_SiPixelDQM.db' )
...
, logconnect = cms.untracked.string( 'sqlite_file:/afs/cern.ch/user/v/vadler/scratch0/cms/SiStripDQM/CMSSW_3_6_1/output/DQMXMLFile_SiPixelDQM_create_log.db' )
