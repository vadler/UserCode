...
, Source          = cms.PSet(
    XMLFile    = cms.untracked.string( '/afs/cern.ch/cms/sw/slc5_ia32_gcc434/cms/cmssw-patch/CMSSW_3_7_0_patch2/src/DQM/SiPixelMonitorClient/test/sipixel_tier0_qualitytest.xml' )
