...
rm -r ../*/${1}
scp /afs/cern.ch/cms/CAF/CMSCOMM/COMM_TRACKER/DQM/SiStrip/jobs/merged/DQM_V0001_SiStrip_${1}-RECO-CAF-${CMSSW_VERSION}_Cluster.root cmstacuser@cmstac11:/data3/CAF/Clusters/
