...
process.ttSemiLepHypKinFit.constraints = cms.vuint32(1, 2, 5)
...
process.ttSemiLepHypKinFitGenMatch.constraints = cms.vuint32(1, 2, 5)
...
process.ttSemiLepEvent.kinFit.chi2 = cms.InputTag("ttSemiLepHypKinFitGenMatch","Chi2")
process.ttSemiLepEvent.kinFit.prob = cms.InputTag("ttSemiLepHypKinFitGenMatch","Prob")
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName     = cms.untracked.string('%s/output/ttSemiLepKinFitEvtBuilder_nuMass.root'%( os.getenv( "CMSSW_BASE" ))),
