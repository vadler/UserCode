...
if not createNTuples:
  ...
  , fileName       = cms.untracked.string( 'gentPatSkimPF2PATBroc_mcFor2012.root' )
...
process.phPFIsoDepositGamma.ExtractorPSet.DR_Veto      = cms.double( 1e-05 )
process.phPFIsoDepositNeutral.ExtractorPSet.DR_Veto    = cms.double( 1e-05 )
process.phPFIsoDepositPU.ExtractorPSet.DR_Veto         = cms.double( 1e-05 )
