cms.PSet(
    ...
    io = cms.PSet(
        ...
        outputFile = cms.string('file:/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_5_3_11/output/fitTopHitFitResolutionFunctions_fromSummer11_Summer12_MCatNLO_L3_unambiguousOnly.root'),
        sample = cms.string('Summer12_MCatNLO_L3_unambiguousOnly'),
        pathPlots = cms.string('/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_5_3_11/output/plots/fitTopHitFitResolutionFunctions/fitTopHitFitResolutionFunctions_fromSummer11_Summer12_MCatNLO_L3_unambiguousOnly_Ref_'),
