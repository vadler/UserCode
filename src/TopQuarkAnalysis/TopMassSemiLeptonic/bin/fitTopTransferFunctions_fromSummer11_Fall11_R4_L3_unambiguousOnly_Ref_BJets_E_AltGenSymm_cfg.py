...
process = cms.PSet(
    ...
    objectCategories = cms.vstring('BJet'),
    ...
    io = cms.PSet(
        sample = cms.string('Fall11_R4_L3_unambiguousOnly'),
        pathPlots = cms.string('/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_4_4_4/output/plots/fitTopTransferFunctions/fitTopTransferFunctions_fromSummer11_Fall11_R4_L3_unambiguousOnly_Ref_'),
        outputFile = cms.string('file:/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_4_4_4/output/fitTopTransferFunctions_fromSummer11_Fall11_R4_L3_unambiguousOnly.root'),
        overwrite = cms.bool(True),
        inputFile = cms.string('file:/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_4_4_4/output/analyzeHitFit_fromSummer11_Fall11_R4_L3_unambiguousOnly.root')
    ),
    histos = cms.PSet(
