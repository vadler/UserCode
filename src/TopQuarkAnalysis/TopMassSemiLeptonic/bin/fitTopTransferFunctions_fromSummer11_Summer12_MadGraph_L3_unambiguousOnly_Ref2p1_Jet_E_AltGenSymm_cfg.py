cms.PSet(
    ...
    io = cms.PSet(
        ...
        pathPlots = cms.string('/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_5_3_11/output/plots/fitTopTransferFunctions/fitTopTransferFunctions_fromSummer11_Summer12_MadGraph_L3_unambiguousOnly_Ref_'),
        outputFile = cms.string('file:/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_5_3_11/output/fitTopTransferFunctions_fromSummer11_Summer12_MadGraph_L3_unambiguousOnly.root'),
