...
process = cms.PSet(
    ...
    io = cms.PSet(
        ...
        pathPlots = cms.string('/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_4_4_4/output/plots/fitTopHitFitResolutionFunctions/plotTopHitFitResolutionFunctions_fromSummer11_Fall11_R4_1_L3_unambiguousOnly_Ref_')
    ),
    plot = cms.PSet(
