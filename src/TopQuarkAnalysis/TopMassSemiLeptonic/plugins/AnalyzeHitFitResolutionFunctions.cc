...
void AnalyzeHitFitResolutionFunctions::beginJob()
{
  ...
  for ( unsigned iCat = 0; iCat < objCats_.size(); ++iCat ) {
    ...
    for ( unsigned iProp = 0; iProp < kinProps_.size(); ++iProp ) {
      ...
      TH2DVec histos_Gen;
      TFileDirectory subDirInvReco( subDir.mkdir( "RecoInv", "" ) );
      ...
      for ( unsigned iEta = 0; iEta < etaBins_.at( iCat ).size() - 1; ++iEta ) {
        ...
        histos_Reco.push_back( subDirReco.make< TH2D >( name_Reco.c_str(), title.c_str(), ptBins_.at( iCat ).size() - 1, ptBins_.at( iCat ).data(), propBins_.at( iCat).at( iProp ), -propMaxs_.at( iCat).at( iProp ), propMaxs_.at( iCat).at( iProp ) ) );
        ...
        const std::string name_Gen( cat + "_" + prop + "_Gen_" + my::helpers::to_string( iEta ) );
        histos_Gen.push_back( subDirGen.make< TH2D >( name_Gen.c_str(), title.c_str(), ptBins_.at( iCat ).size() - 1, ptBins_.at( iCat ).data(), propBins_.at( iCat).at( iProp ), -propMaxs_.at( iCat).at( iProp ), propMaxs_.at( iCat).at( iProp ) ) );
        histos_Gen.back()->SetXTitle( xTitleGen.c_str() );
        histos_Gen.back()->SetYTitle( yTitle.c_str() );
        histos_Gen.back()->SetZTitle( zTitle.c_str() );
        const std::string name_RecoInv( cat + "_" + prop + "_RecoInv_" + my::helpers::to_string( iEta ) );
        histos_RecoInv.push_back( subDirInvReco.make< TH2D >( name_RecoInv.c_str(), title.c_str(), ptBins_.at( iCat ).size() - 1, ptBins_.at( iCat ).data(), propInvBins_.at( iCat).at( iProp ), -propInvMaxs_.at( iCat).at( iProp ), propInvMaxs_.at( iCat).at( iProp ) ) );
        ...
        const std::string name_GenInv( cat + "_" + prop + "_GenInv_" + my::helpers::to_string( iEta ) );
        histos_GenInv.push_back( subDirInvGen.make< TH2D >( name_GenInv.c_str(), title.c_str(), ptBins_.at( iCat ).size() - 1, ptBins_.at( iCat ).data(), propInvBins_.at( iCat).at( iProp ), -propInvMaxs_.at( iCat).at( iProp ), propInvMaxs_.at( iCat).at( iProp ) ) );
      ...
      for ( unsigned iEtaSymm = 0; iEtaSymm < etaSymmBins_.at( iCat ).size() - 1; ++iEtaSymm ) {
        ...
        histos_RecoSymm.push_back( subDirRecoSymm.make< TH2D >( name_RecoSymm.c_str(), title.c_str(), ptBins_.at( iCat ).size() - 1, ptBins_.at( iCat ).data(), propBins_.at( iCat).at( iProp ), -propMaxs_.at( iCat).at( iProp ), propMaxs_.at( iCat).at( iProp ) ) );
        ...
        const std::string name_GenSymm( cat + "_" + prop + "_GenSymm_" + my::helpers::to_string( iEtaSymm ) );
        histos_GenSymm.push_back( subDirGenSymm.make< TH2D >( name_GenSymm.c_str(), title.c_str(), ptBins_.at( iCat ).size() - 1, ptBins_.at( iCat ).data(), propBins_.at( iCat).at( iProp ), -propMaxs_.at( iCat).at( iProp ), propMaxs_.at( iCat).at( iProp ) ) );
        ...
        const std::string name_RecoInvSymm( cat + "_" + prop + "_RecoInvSymm_" + my::helpers::to_string( iEtaSymm ) );
        histos_RecoInvSymm.push_back( subDirRecoInvSymm.make< TH2D >( name_RecoInvSymm.c_str(), title.c_str(), ptBins_.at( iCat ).size() - 1, ptBins_.at( iCat ).data(), propInvBins_.at( iCat).at( iProp ), -propInvMaxs_.at( iCat).at( iProp ), propInvMaxs_.at( iCat).at( iProp ) ) );
        ...
        const std::string name_GenInvSymm( cat + "_" + prop + "_GenInvSymm_" + my::helpers::to_string( iEtaSymm ) );
        histos_GenInvSymm.push_back( subDirGenInvSymm.make< TH2D >( name_GenInvSymm.c_str(), title.c_str(), ptBins_.at( iCat ).size() - 1, ptBins_.at( iCat ).data(), propInvBins_.at( iCat).at( iProp ), -propInvMaxs_.at( iCat).at( iProp ), propInvMaxs_.at( iCat).at( iProp ) ) );
