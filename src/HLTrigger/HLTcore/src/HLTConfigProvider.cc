...
// DEBUG   LogVerbatim("HLTConfigProvider") << "Unordered list of all process names found: "
// DEBUG				    << pNames << "." << endl;
   cout << "HLTConfigProvider:   Unordered list of all process names found: " << pNames << "." << endl; // DEBUG

// DEBUG   LogVerbatim("HLTConfigProvider") << "HLT TableName of each selected process: "
// DEBUG				    << hNames << "." << endl;
   cout << "HLTConfigProvider:   HLT TableName of each selected process:    " << hNames << "." << endl; // DEBUG

   if (nPSets==0) {
     clear();
// DEBUG     LogError("HLTConfigProvider") << " Process name '"
// DEBUG				   << processName
// DEBUG				   << "' not found in registry!" << endl;
     cout << "HLTConfigProvider:   Process name '" << processName << "' not found in registry!" << endl; // DEBUG
     return false;
   }
...
// DEBUG     LogError("HLTConfigProvider") << " Process name '"
// DEBUG				   << processName
// DEBUG				   << "' found but ParameterSetID invalid!"
// DEBUG				   << endl;
     cout << "HLTConfigProvider:   Process name '" << processName << "' found but ParameterSetID invalid!" << endl; // DEBUG
     return false;
   }
   if (nPSets>1) {
     clear();
...
// DEBUG				   << processName
// DEBUG				   << " found " << nPSets
// DEBUG				   << " times in registry!" << endl;
     cout << "HLTConfigProvider:   Process name '" << processName << " found " << nPSets << " times in registry!" << endl; // DEBUG
     return false;
   }
   ...
   if (!(registry_->getMapped(psetID,pset))) {
     clear();
// DEBUG     LogError("HLTConfigProvider") << " ProcessPSet for ProcessPSetID '"
// DEBUG				   << psetID
// DEBUG				   << "' not found in registry!" << endl;
     cout << "HLTConfigProvider:   ProcessPSet for ProcessPSetID '" << psetID << "' not found in registry!" << endl; // DEBUG
     return false;
   }
